import com.network.framework.server;
import com.network.framework.common;
import java.util.*;
import java.awt.*;
import javax.swing.*;
import java.awt.event.*;
class Application implements RequestListener
{
//Taken a pointer of TMNetworkServer---
private TMNetworkServer tmNetworkServer;
//-----------------------------------------------
Application()
{
//networkServer object created
tmNetworkServer=new TMNetworkServer(5000,5001,this);
System.out.println("Server instantiated");
}
//Three functions which is compulsury to write because we have //implemented the interface RequestListener...
...
//here the application should wait till the socket get closes. 
